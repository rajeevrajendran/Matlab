...
Prelude={'Apocalypse Nigh','Beginning of the end','Blank','Blank with Antarctica','Call of Cthulhu','Dark blessings',...
...
% Pldconditions ={'After resolving setup, if Shudde M'ell is not the Ancient One, place 1 Eldritch Token each on space 2, 5, 8, and 11 of the Doom track. If Shudde M'ell is the Ancient one, place 1 Eldritch token on space 14 of the Doom track. Then, the Lead investigator discards 1 Gate on a space of his choice, or each investigator gains 1 Talent Condition. During this game, if Shudde M'ell is not the Ancient One, when Doom advances to a space containing an Eldritch Token, draw an resolve a Disaster. Then, discard that Eldritch token.',... % Apocalypse Nigh
